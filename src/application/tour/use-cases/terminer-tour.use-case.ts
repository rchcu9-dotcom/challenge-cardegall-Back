...
export class TerminerTourUseCase {
  ...
  async execute(action: ActionFinTour, parametres?: ParametresTour): Promise<TerminerTourResultDto> {
    ...
    const classementFinal = this.classementService.calculer(equipes, tousLesMatchs);
    ...
    const parametresNouveauTour: ParametresTour =
      parametres ?? {
